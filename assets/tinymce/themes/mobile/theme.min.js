!(function() {
	...
	var Zr = function(n, e, t) {
		...
		ao = function(n, e, t) {
			...
			return (
				0 < r.length ? ro.set(n, e, r.join(' ')) : ro.remove(n, e), !1
			);
		},
		co = function(n) {
			return io(n, 'class');
	...
	var $i,
		...
		Cu = Object.freeze({
			...
			getHighlighted: function(e, n, t) {
				return ou(e.element(), '.' + n.highlightClass()).bind(function(
					n
				) {
					return e
						.getSystem()
			...
			return Js.sketch({
				...
				components: [
					Js.parts().spectrum({
						...
						components: [
							gs('<div class="${prefix}-slider-size-line"></div>')
						]
					}),
					Js.parts().thumb({
	...
	var Sf,
		...
		um = function(n, e, t, r, o) {
			var i = im(t, r);
			return (
				n.dom().addEventListener(e, i, o), { unbind: l(am, n, e, i, o) }
			);
		},
		am = function(n, e, t, r) {
