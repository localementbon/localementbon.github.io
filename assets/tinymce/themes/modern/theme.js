(function() {
	var modern = (function() {
		...
		var addContextualToolbars = function(editor) {
			...
			var bindScrollEvent = function(panel) {
				if (!scrollContainer) {
					...
					var uiContainer_1 = $_5kmlp5u4jkmcwsge.getUiContainer(
						panel
					);
					scrollContainer =
			...
			var showContextToolbar = function(match) {
				...
				panel = global$4.create({
					...
					fixed: true,
					border: 1,
					items: $_5g1hacu7jkmcwsgn.createToolbar(
						editor,
						match.toolbar.items
					),
					oncancel: function() {
		...
		var cleanupMenu = function(namedMenuItems, removedMenuItems) {
			var menuItemsPass1 = filter(namedMenuItems, function(
				namedMenuItem
			) {
				return (
			...
			return filter(menuItemsPass2, function(
				namedMenuItem,
				i,
				namedMenuItems
			) {
		...
		var editAreaContainer = function(editor) {
			return {
				...
				border: '1 0 0 0',
				items: [editArea('0'), $_93h32bucjkmcwsh7.createSidebar(editor)]
			};
		};
						...
						items: [
							hasMenubar(editor) === false
								...
								: {
										type: 'menubar',
										border: '0 0 1 0',
										items: $_3ke8tlu8jkmcwsgq.createMenuButtons(
											editor
										)
								  },
							$_5g1hacu7jkmcwsgn.createToolbars(
								editor,
								getToolbarSize(editor)
							)
						]
					},
					$_93h32bucjkmcwsh7.hasSidebar(editor)
		...
		function calculateRelativePosition(ctrl, targetElm, rel) {
			...
			pos = funcs.getPos(
				targetElm,
				$_5kmlp5u4jkmcwsge.getUiContainer(ctrl)
			);
			x = pos.x;
			y = pos.y;
		...
		var proto$1 = {
			...
			init: function(settings) {
				...
				self$$1.borderBox = $_79d0aauqjkmcwsj9.parseBox(
					settings.border
				);
				self$$1.paddingBox = $_79d0aauqjkmcwsj9.parseBox(
					settings.padding
				);
				self$$1.marginBox = $_79d0aauqjkmcwsj9.parseBox(
					settings.margin
				);
				if (settings.hidden) {
					self$$1.hide();
			...
			initLayoutRect: function() {
				...
				borderBox = self$$1.borderBox =
					self$$1.borderBox ||
					$_79d0aauqjkmcwsj9.measureBox(elm, 'border');
				self$$1.paddingBox =
					self$$1.paddingBox ||
					$_79d0aauqjkmcwsj9.measureBox(elm, 'padding');
				self$$1.marginBox =
					self$$1.marginBox ||
					$_79d0aauqjkmcwsj9.measureBox(elm, 'margin');
		...
		var FloatPanel = Panel.extend({
			Mixins: [$_77p0ikukjkmcwsie, $_4ci2x6v1jkmcwski],
			init: function(settings) {
				var self$$1 = this;
		...
		var renderUI = function(editor, theme, args) {
			...
			return isInline(editor)
				? $_aqv3nuufjkmcwshc.render(editor, theme, args)
				: $_9mz4sntvjkmcwsft.render(editor, theme, args);
		};
		...
		var isComment = function(element) {
			return (
				type(element) === $_g9js5fw5jkmcwsoh.COMMENT ||
		...
		var inBody = function(element) {
			var dom = $_dg0wqww4jkmcwsog.isText(element)
		...
		var detectBrowser = function(browsers, userAgent) {
			return detect$1(browsers, userAgent).map(function(browser) {
				var version = $_7ota5pwljkmcwsq4.detect(
		...
		var detect$2 = function(userAgent) {
			...
			var browser = $_21yllowojkmcwsqc
				.detectBrowser(browsers, userAgent)
				.fold($_fknyifwkjkmcwsq1.unknown, $_fknyifwkjkmcwsq1.nu);
			var os = $_21yllowojkmcwsqc
				.detectOs(oses, userAgent)
				.fold($_4dmnqawmjkmcwsq6.unknown, $_4dmnqawmjkmcwsq6.nu);
		...
		var ieContains = function(e1, e2) {
			return $_60zxbqwejkmcwspr.documentPositionContainedBy(
				e1.dom(),
				e2.dom()
			);
		};
		...
		var ancestors$1 = function(scope, selector, isRoot) {
			return $_bf8vd5w1jkmcwso8.ancestors(
				scope,
				function(e) {
		...
		var ancestor$1 = function(scope, selector, isRoot) {
			return $_13w0c1wzjkmcwsri.ancestor(
				scope,
				function(e) {
					return $_3tbwnywtjkmcwsqr.is(e, selector);
				},
		...
		var trimMenuItems = function(menuItems) {
			var menuItems2 = filter(menuItems, function(
				...
				return (
					!isSeparator$1(menuItem) || !isSeparator$1(menuItems[i - 1])
				);
			});
		...
		var setupUiContainer = function(editor) {
			if (editor.settings.ui_container) {
				global$8.container = $_epq3p6wyjkmcwsrh
					.descendant(
