	...
	var table = (function() {
		...
		var detectBrowser = function(browsers, userAgent) {
			return detect$1(browsers, userAgent).map(function(browser) {
				var version = $_976zrilujkmcwq2p.detect(
		...
		var detect$2 = function(userAgent) {
			...
			var browser = $_cg17vxlxjkmcwq2y
				.detectBrowser(browsers, userAgent)
				.fold($_dz7zrfltjkmcwq2m.unknown, $_dz7zrfltjkmcwq2m.nu);
			var os = $_cg17vxlxjkmcwq2y
				.detectOs(oses, userAgent)
				.fold($_g7j7j5lvjkmcwq2r.unknown, $_g7j7j5lvjkmcwq2r.nu);
		...
		var ieContains = function(e1, e2) {
			return $_eppdkllmjkmcwq2a.documentPositionContainedBy(
				e1.dom(),
				e2.dom()
			);
		};
		...
		var filterFirstLayer = function(scope, selector, predicate) {
			return bind($_9z5e1kljjkmcwq1g.children(scope), function(x) {
				return $_dvr0jtlfjkmcwq0n.is(x, selector)
					? predicate(x)
						? [x]
						: []
		...
		var isComment = function(element) {
			return (
				type(element) === $_3d1bcmlijkmcwq1d.COMMENT ||
		...
		var transfer = function(source, destination, attrs) {
			if (
				!$_5hranzm3jkmcwq3l.isElement(source) ||
				!$_5hranzm3jkmcwq3l.isElement(destination)
			)
				return;
		...
		var inBody = function(element) {
			var dom = $_5hranzm3jkmcwq3l.isText(element)
		...
		var ancestors$1 = function(scope, selector, isRoot) {
			return $_dk5vi4m5jkmcwq3p.ancestors(
				scope,
				function(e) {
		...
		var ancestor$1 = function(scope, selector, isRoot) {
			return $_8rq19vm8jkmcwq44.ancestor(
				scope,
				function(e) {
					return $_dvr0jtlfjkmcwq0n.is(e, selector);
				},
		...
		var lookup = function(tags, element, _isRoot) {
			...
			var isRootOrUpperTable = function(element) {
				return (
					$_dvr0jtlfjkmcwq0n.is(element, 'table') || isRoot(element)
				);
			};
			return $_87tdfem7jkmcwq42.ancestor(
				element,
				tags.join(','),
				isRootOrUpperTable
			);
		...
		var fromTable = function(table) {
			...
			return map(rows, function(row) {
				...
				var cells = map($_66sys5ldjkmcwpzo.cells(row), function(cell) {
					var rowspan = $_98tfuqm2jkmcwq3d.has(cell, 'rowspan')
						? parseInt($_98tfuqm2jkmcwq3d.get(cell, 'rowspan'), 10)
						: 1;
					var colspan = $_98tfuqm2jkmcwq3d.has(cell, 'colspan')
						? parseInt($_98tfuqm2jkmcwq3d.get(cell, 'colspan'), 10)
						: 1;
					return $_7jwbndlcjkmcwpzk.detail(cell, rowspan, colspan);
				});
				return $_7jwbndlcjkmcwpzk.rowdata(
					element,
					cells,
					parentSection
				);
		...
		var generate = function(list) {
			...
			each(list, function(details, r) {
				...
				each(details.cells(), function(detail, c) {
					...
					var current = $_7jwbndlcjkmcwpzk.extended(
						detail.element(),
						detail.rowspan(),
						detail.colspan(),
						r,
		...
		var get$1 = function(element, property) {
			...
			var v =
				r === '' && !$_d3qhw3m6jkmcwq3s.inBody(element)
					? getUnsafeProperty(dom, property)
					: r;
			return v === null ? undefined : v;
		};
		var getUnsafeProperty = function(dom, property) {
			return $_893sammcjkmcwq58.isSupported(dom)
		...
		var remove$1 = function(element, property) {
			...
			if (
				$_98tfuqm2jkmcwq3d.has(element, 'style') &&
				trim($_98tfuqm2jkmcwq3d.get(element, 'style')) === ''
			) {
		...
		var preserve = function(element, f) {
			...
			var restore =
				oldStyles === undefined
					? $_98tfuqm2jkmcwq3d.remove
					: $_98tfuqm2jkmcwq3d.set;
		...
		var copy = function(source, target) {
			...
			if (
				$_893sammcjkmcwq58.isSupported(sourceDom) &&
				$_893sammcjkmcwq58.isSupported(targetDom)
			) {
		...
		var appendAt = function(parent, element, index) {
			$_9z5e1kljjkmcwq1g.child(parent, index).fold(
				function() {
					append(parent, element);
				},
				function(v) {
		...
		var makeCell = function(list, seenSelected, rowIndex) {
			...
			var f = seenSelected
				? $_504takmdjkmcwq59.append
				: $_504takmdjkmcwq59.prepend;
			f(row, td);
		};
			...
			for (var i = 0; i < totalRows; i++) {
				...
				for (var j = 0; j < totalColumns; j++) {
					if (
						...
						var needCell = $_8t4rmkmajkmcwq4k
							.getAt(house, i, j)
							.filter(isSelected)
							.isNone();
		...
		var clean = function(table, stats) {
			var emptyRows = filter(
				$_a7t945lejkmcwq0d.firstLayer(table, 'tr'),
				function(row) {
			...
			if (
				...
				each($_a7t945lejkmcwq0d.firstLayer(table, 'th,td'), function(
					cell
				) {
		...
		var extract = function(table, selectedSelector) {
			...
			var selector =
				...
				selectedSelector +
				')';
			var unselectedCells = $_a7t945lejkmcwq0d.filterFirstLayer(
				table,
				'th,td',
				function(cell) {
		...
		var getEnd = function(element) {
			return $_5hranzm3jkmcwq3l.name(element) === 'img'
				? 1
				: $_gelocgmkjkmcwq6n.getOption(element).fold(
						function() {
		...
		var first$3 = function(element) {
			return $_8rq19vm8jkmcwq44.descendant(
				element,
				$_8b7hivmjjkmcwq6j.isCursorPosition
			);
		};
		...
		var replace = function(cell, tag, attrs) {
			...
			each$1(attrs, function(v, k) {
				if (v === null) $_98tfuqm2jkmcwq3d.remove(replica, k);
				else $_98tfuqm2jkmcwq3d.set(replica, k, v);
			});
			return replica;
		};
		...
		var cloneFormats = function(oldCell, newCell, formats) {
			...
			return first
				.map(function(firstText) {
					...
					var parents = $_6ib2l3m4jkmcwq3n.ancestors(
						firstText,
						formatSelector,
						function(element) {
					...
					return foldr(
						...
						function(last$$1, parent) {
							var clonedFormat = $_fd9y5qmhjkmcwq6d.shallow(
								parent
							);
							$_98tfuqm2jkmcwq3d.remove(
								clonedFormat,
		...
		var cellOperations = function(mutate, doc, formatsToClone) {
			var newCell = function(prev) {
				...
				var td = Element$$1.fromTag(
					$_5hranzm3jkmcwq3l.name(prev.element()),
					doc.dom()
				);
		...
		function DomUniverse() {
			...
			var isBoundary = function(element) {
				if (!$_5hranzm3jkmcwq3l.isElement(element)) return false;
				if ($_5hranzm3jkmcwq3l.name(element) === 'body') return true;
				return contains(
					TagBoundaries,
		...
		var ancestors$3 = function(universe, start, finish, _isRoot) {
			return $_eohsxbmxjkmcwqac.ancestors(
				universe,
				start,
				finish,
				_isRoot
		...
		var sharedOne$1 = function(look, elements) {
			return $_8jftilmujkmcwq9r.sharedOne(
				universe,
		...
		var ancestors$4 = function(start, finish, _isRoot) {
			return $_8jftilmujkmcwq9r.ancestors(
				universe,
				start,
				finish,
				_isRoot
		...
		var breakPath$2 = function(child, isTop, breaker) {
			return $_8jftilmujkmcwq9r.breakPath(
				universe,
				child,
				isTop,
				function(u, p, c) {
		...
		var getBounds = function(detailA, detailB) {
			return $_7jwbndlcjkmcwpzk.bounds(
		...
		var getAnyBox = function(warehouse, startCell, finishCell) {
			var startCoords = $_8t4rmkmajkmcwq4k.findItem(
				warehouse,
				startCell,
				$_3jfu9slljkmcwq20.eq
			);
			var finishCoords = $_8t4rmkmajkmcwq4k.findItem(
				warehouse,
				finishCell,
				$_3jfu9slljkmcwq20.eq
			);
		...
		var moveBy = function(warehouse, cell, row, column) {
			return $_8t4rmkmajkmcwq4k
				.findItem(warehouse, cell, $_3jfu9slljkmcwq20.eq)
				.bind(function(detail) {
					...
					var startCol =
						column > 0
							...
							: detail.column();
					var dest = $_8t4rmkmajkmcwq4k.getAt(
						warehouse,
						startRow + row,
						startCol + column
					);
		...
		var intercepts = function(warehouse, start, finish) {
			return $_3ejnqmn1jkmcwqb2
				.getAnyBox(warehouse, start, finish)
				.map(function(bounds) {
					var inside = $_8t4rmkmajkmcwq4k.filterItems(
						warehouse,
						curry($_fos321n0jkmcwqaw.inSelection, bounds)
					);
		...
		var moveBy$1 = function(cell, deltaRow, deltaColumn) {
			return $_66sys5ldjkmcwpzo.table(cell).bind(function(table) {
				...
				return $_bm7aoxmzjkmcwqao.moveBy(
					warehouse,
					cell,
					deltaRow,
					deltaColumn
		...
		var nestedIntercepts = function(
			...
			var warehouse = getWarehouse(table);
			var startCell = $_3jfu9slljkmcwq20.eq(table, firstTable)
				? first
				: $_bm7aoxmzjkmcwqao.parentCell(warehouse, first);
			var lastCell = $_3jfu9slljkmcwq20.eq(table, lastTable)
				? last
				: $_bm7aoxmzjkmcwqao.parentCell(warehouse, last);
			return $_bm7aoxmzjkmcwqao.intercepts(
				warehouse,
				startCell,
				lastCell
			);
		...
		var identify = function(start, finish, isRoot) {
			var getIsRoot = function(rootTable) {
				return function(element) {
					return (
						isRoot(element) ||
						$_3jfu9slljkmcwq20.eq(element, rootTable)
					);
				};
			};
			if ($_3jfu9slljkmcwq20.eq(start, finish)) {
				...
				return lookupTable(start, isRoot).bind(function(startTable) {
					return lookupTable(finish, isRoot).bind(function(
						finishTable
					) {
						if ($_3jfu9slljkmcwq20.eq(startTable, finishTable)) {
							return Option.some(
								identified({
									boxes: $_6bo0kumyjkmcwqak.intercepts(
										startTable,
										start,
										finish
									),
							...
							$_3jfu9slljkmcwq20.contains(startTable, finishTable)
						) {
							var ancestorCells = $_6ib2l3m4jkmcwq3n.ancestors(
								finish,
								'td,th',
							...
							return Option.some(
								identified({
									boxes: $_6bo0kumyjkmcwqak.nestedIntercepts(
										startTable,
										start,
										startTable,
										finish,
							...
							$_3jfu9slljkmcwq20.contains(finishTable, startTable)
						) {
							var ancestorCells = $_6ib2l3m4jkmcwq3n.ancestors(
								start,
								'td,th',
							...
							return $_cqkw3imrjkmcwq8k
								.ancestors(start, finish)
								.shared()
								.bind(function(lca) {
									return $_87tdfem7jkmcwq42
										.closest(lca, 'table', isRoot)
										.bind(function(lcaTable) {
											var finishAncestorCells = $_6ib2l3m4jkmcwq3n.ancestors(
												finish,
												'td,th',
												getIsRoot(lcaTable)
											);
											var finishCell =
												finishAncestorCells.length > 0
													...
													: finish;
											var startAncestorCells = $_6ib2l3m4jkmcwq3n.ancestors(
												start,
												'td,th',
												getIsRoot(lcaTable)
											);
			...
			return $_87tdfem7jkmcwq42
				...
				.bind(function(table) {
					return $_87tdfem7jkmcwq42
						...
						.bind(function(start) {
							return identify(start, finish).bind(function(
								identified
							) {
		...
		var retrieveBox = function(
			...
			return $_ae41j1mqjkmcwq7w
				...
				.bind(function(edges) {
					...
					var firstAncestor = $_87tdfem7jkmcwq42.ancestor(
						edges.first(),
						'thead,tfoot,tbody,table',
						isRoot
					);
					var lastAncestor = $_87tdfem7jkmcwq42.ancestor(
						edges.last(),
						'thead,tfoot,tbody,table',
						isRoot
					);
					return firstAncestor.bind(function(fA) {
						return lastAncestor.bind(function(lA) {
							return $_3jfu9slljkmcwq20.eq(fA, lA)
								? $_6bo0kumyjkmcwqak.getBox(
										edges.table(),
										edges.first(),
										edges.last()
								  )
		...
		var unmergable = function(cell, selections) {
			var hasSpan = function(elem) {
				return (
					($_98tfuqm2jkmcwq3d.has(elem, 'rowspan') &&
						parseInt($_98tfuqm2jkmcwq3d.get(elem, 'rowspan'), 10) >
							1) ||
					($_98tfuqm2jkmcwq3d.has(elem, 'colspan') &&
						parseInt($_98tfuqm2jkmcwq3d.get(elem, 'colspan'), 10) >
							1)
				);
			};
		...
		var mergable = function(table, selections) {
			return $_62kqdcn3jkmcwqba.cata(
				...
				function(cells, _env) {
					...
					return $_btnclampjkmcwq7i
						.retrieveBox(
							table,
							$_44m387n2jkmcwqb8.firstSelectedSelector(),
							$_44m387n2jkmcwqb8.lastSelectedSelector()
						)
		...
		var forMenu = function(selections, table, cell) {
			return {
				element: constant(cell),
				mergable: constant(
					$_aj06mymojkmcwq74.mergable(table, selections)
				),
				unmergable: constant(
					$_aj06mymojkmcwq74.unmergable(cell, selections)
				),
				selection: constant(
					$_aj06mymojkmcwq74.selection(cell, selections)
				)
			};
		};
		...
		var extractSelected = function(cells) {
			return $_66sys5ldjkmcwpzo
				.table(cells[0])
				.map($_fd9y5qmhjkmcwq6d.deep)
				.map(function(replica) {
					return [
						$_fye74ll5jkmcwpyg.extract(
							replica,
							$_44m387n2jkmcwqb8.attributeSelector()
						)
					];
				});
		};
				...
				if (e.selection === true && e.paste === true) {
					...
					cellOpt.each(function(domCell) {
						...
						table.bind(function(table) {
							var elements = filter(
								$_1rltvxmmjkmcwq6u.fromHtml(e.content),
								function(content) {
									return (
										$_5hranzm3jkmcwq3l.name(content) !==
										'meta'
									);
								}
							);
		...
		var api$1 = Dimension('height', function(element) {
			var dom = element.dom();
			return $_d3qhw3m6jkmcwq3s.inBody(element)
		...
		var getHeight = function(cell) {
			return needManualCalc()
				...
				: getProp(cell, 'height', $_ebklwon9jkmcwqcu.get(cell));
		};
		...
		var normalizePixelSize = function(value, cell, getter, setter) {
			...
			return endsWith(value, '%') &&
				$_5hranzm3jkmcwq3l.name(cell) !== 'table'
				? convert(cell, number, getter, setter)
				: number;
		};
		var getTotalHeight = function(cell) {
			var value = getHeightValue(cell);
			if (!value) return $_ebklwon9jkmcwqcu.get(cell);
			return normalizePixelSize(
				value,
				cell,
				$_ebklwon9jkmcwqcu.get,
				setHeight
			);
		};
		...
		var getSpan = function(cell, type) {
			return $_98tfuqm2jkmcwq3d.has(cell, type)
				? parseInt($_98tfuqm2jkmcwq3d.get(cell, type), 10)
				: 1;
		};
		var getRawWidth = function(element) {
			...
			return cssWidth.fold(
				function() {
					return Option.from(
						$_98tfuqm2jkmcwq3d.get(element, 'width')
					);
				},
				function(width) {
		...
		var halve = function(main, other) {
			...
			width.each(function(width) {
				...
				$_expxtvn7jkmcwqc2.setGenericWidth(
					main,
					newWidth,
					width.unit()
				);
		...
		var attached = function(element, scope) {
			...
			return $_8rq19vm8jkmcwq44
				.ancestor(element, curry($_3jfu9slljkmcwq20.eq, doc))
				.isSome();
		};
		var windowOf = function(element) {
			var dom = element.dom();
			if (dom === dom.window && element instanceof Window) return element;
			return $_5hranzm3jkmcwq3l.isDocument(element)
		...
		var getBottomEdge = function(index, cell) {
			return rowInfo(
				index,
				getTop(cell) + $_ebklwon9jkmcwqcu.getOuter(cell)
			);
		};
		...
		function TableDirection(directionAt) {
			var auto = function(table) {
				return directionAt(table).isRtl()
					? $_90vywdndjkmcwqd4.rtl
					: $_90vywdndjkmcwqd4.ltr;
			};
		...
		var elementToData = function(element) {
			var colspan = $_98tfuqm2jkmcwq3d.has(element, 'colspan')
				? parseInt($_98tfuqm2jkmcwq3d.get(element, 'colspan'), 10)
				: 1;
			var rowspan = $_98tfuqm2jkmcwq3d.has(element, 'rowspan')
				? parseInt($_98tfuqm2jkmcwq3d.get(element, 'rowspan'), 10)
				: 1;
			return {
		...
		var merge = function(cells) {
			...
			var advancedBr = function(children) {
				return forall(children, function(c) {
					return (
						isBr(c) ||
						($_5hranzm3jkmcwq3l.isText(c) &&
							$_gelocgmkjkmcwq6n.get(c).trim().length === 0)
					);
				});
			};
			var isListItem = function(el) {
				return (
					$_5hranzm3jkmcwq3l.name(el) === 'li' ||
					$_8rq19vm8jkmcwq44
						.ancestor(el, $_fm83ehnojkmcwqfz.isList)
						.isSome()
				);
			};
			var siblingIsBlock = function(el) {
				return $_9z5e1kljjkmcwq1g
					.nextSibling(el)
					.map(function(rightSibling) {
						if ($_fm83ehnojkmcwqfz.isBlock(rightSibling))
							return true;
						if ($_fm83ehnojkmcwqfz.isEmptyTag(rightSibling)) {
							return $_5hranzm3jkmcwq3l.name(rightSibling) ===
								'img'
								? false
								: true;
						}
						...
						return $_9z5e1kljjkmcwq1g
							...
							.map(function(parent) {
								return rightSiblingIsBlock === true ||
									isListItem(parent) ||
									isBr(rightEdge) ||
									($_fm83ehnojkmcwqfz.isBlock(parent) &&
										!$_3jfu9slljkmcwq20.eq(cell, parent))
									? []
		...
		var toDetails = function(grid, comparator) {
			...
			return map(grid, function(row, ri) {
				var details = bind(row.cells(), function(cell, ci) {
					if (seen[ri][ci] === false) {
						var result = $_bfptp2nujkmcwqh2.subgrid(
							grid,
							ri,
							ci,
							comparator
		...
		var toGrid = function(warehouse, generators, isNew) {
			...
			for (var i = 0; i < warehouse.grid().rows(); i++) {
				...
				for (var j = 0; j < warehouse.grid().columns(); j++) {
					var element = $_8t4rmkmajkmcwq4k
						.getAt(warehouse, i, j)
						.map(function(item) {
							return $_7jwbndlcjkmcwpzk.elementnew(
								item.element(),
								isNew
							);
						})
				...
				var row = $_7jwbndlcjkmcwpzk.rowcells(
					rowCells,
		...
		var setIfNot = function(element, property, value, ignore) {
			if (value === ignore) $_98tfuqm2jkmcwq3d.remove(element, property);
			else $_98tfuqm2jkmcwq3d.set(element, property, value);
		};
		var render = function(table, grid) {
			var newRows = [];
			var newCells = [];
			var renderSection = function(gridSection, sectionName) {
				var section = $_87tdfem7jkmcwq42
					.child(table, sectionName)
					.getOrThunk(function() {
						var tb = Element$$1.fromTag(
							sectionName,
							$_9z5e1kljjkmcwq1g.owner(table).dom()
						);
		...
		var remove$3 = function(element, attr, id) {
			...
			if (nu.length > 0)
				$_98tfuqm2jkmcwq3d.set(element, attr, nu.join(' '));
			else $_98tfuqm2jkmcwq3d.remove(element, attr);
			return false;
		};
		...
		var add$2 = function(element, clazz) {
			...
			else $_4hy5b1o5jkmcwqji.add(element, clazz);
		};
		var cleanClass = function(element) {
			var classList = $_4hy5b1o5jkmcwqji.supports(element)
				? element.dom().classList
				: $_4hy5b1o5jkmcwqji.get(element);
		...
		var remove$5 = function(element, clazz) {
			...
			} else $_4hy5b1o5jkmcwqji.remove(element, clazz);
			cleanClass(element);
		};
		var toggle$1 = function(element, clazz) {
			return $_4hy5b1o5jkmcwqji.supports(element)
				? element.dom().classList.toggle(clazz)
				: $_4hy5b1o5jkmcwqji.toggle(element, clazz);
		};
		...
		var has$1 = function(element, clazz) {
			return (
				$_4hy5b1o5jkmcwqji.supports(element) &&
		...
		var clear = function(wire) {
			var previous = $_6ib2l3m4jkmcwq3n.descendants(
				wire.parent(),
				'.' + resizeBar
			);
		...
		var refreshCol = function(wire, colPositions, position, tableHeight) {
			drawBar(wire, colPositions, function(origin, cp) {
				var colBar = $_bii7beo0jkmcwqj4.col(
					cp.col(),
					cp.x() - origin.left(),
		...
		var refreshRow = function(wire, rowPositions, position, tableWidth) {
			drawBar(wire, rowPositions, function(origin, cp) {
				var rowBar = $_bii7beo0jkmcwqj4.row(
					cp.row(),
		...
		var refreshGrid = function(
			...
			refreshRow(
				...
				rowPositions,
				position,
				$_7r37ipnbjkmcwqd1.getOuter(table)
			);
			var colPositions =
			...
			refreshCol(
				...
				colPositions,
				position,
				$_ebklwon9jkmcwqcu.getOuter(table)
			);
		};
		...
		var each$2 = function(wire, f) {
			var bars = $_6ib2l3m4jkmcwq3n.descendants(
				wire.parent(),
				'.' + resizeBar
			);
			each(bars, f);
		...
		var deriveRows = function(rendered, generators) {
			...
			return map(rendered, function(details) {
				...
				return $_7jwbndlcjkmcwpzk.rowdatanew(
					row.element(),
					details.details(),
					details.section(),
					row.isNew()
		...
		var toDetailList = function(grid, generators) {
			var rendered = $_13owsxntjkmcwqgt.toDetails(
				grid,
				$_3jfu9slljkmcwq20.eq
			);
		...
		var run = function(
			...
			return function(wire, table, target, generators, direction) {
				...
				return output.fold(
					...
					function(out) {
						var newElements = $_4g8n7enwjkmcwqhc.render(
							table,
							out.grid()
						);
						adjustment(table, out.grid(), direction);
						postAction(table);
						$_ax6148nxjkmcwqi0.refresh(
							wire,
							table,
							$_1daexhnejkmcwqd5.height,
							direction
						);
						return Option.some({
							cursor: out.cursor,
		...
		var onPaste = function(warehouse, target) {
			return $_66sys5ldjkmcwpzo
				.cell(target.element())
				.bind(function(cell) {
					return findInWarehouse(warehouse, cell).map(function(
						details
					) {
		...
		var measure = function(startAddress, gridA, gridB) {
			if (
				...
				startAddress.column() > $_gdbsl0nvjkmcwqh8.cellLength(gridA[0])
			)
				return Result.error(
		...
		var rowFill = function(grid, amount, generator) {
			return grid.concat(
				$_cmkixrnzjkmcwqiw.repeat(amount, function(_row) {
					return $_gdbsl0nvjkmcwqh8.setCells(
						grid[grid.length - 1],
			...
			return map(grid, function(row) {
				return $_gdbsl0nvjkmcwqh8.setCells(
					...
					row
						.cells()
						.concat(
							fill($_cmkixrnzjkmcwqiw.range(0, amount), generator)
						)
				);
			});
		};
		...
		var merge$2 = function(grid, bounds, comparator, substitution) {
			...
			for (var i = bounds.startRow(); i <= bounds.finishRow(); i++) {
				for (var j = bounds.startCol(); j <= bounds.finishCol(); j++) {
					$_gdbsl0nvjkmcwqh8.mutateCell(
						grid[i],
						j,
						$_7jwbndlcjkmcwpzk.elementnew(substitution(), false)
					);
				}
			}
			return grid;
		...
		var unmerge = function(grid, target, comparator, substitution) {
			...
			for (var i = 0; i < grid.length; i++) {
				for (
					var j = 0;
					j < $_gdbsl0nvjkmcwqh8.cellLength(grid[0]);
					j++
				) {
					...
					if (isToReplace === true && first === false) {
						$_gdbsl0nvjkmcwqh8.mutateCell(
							grid[i],
							j,
							$_7jwbndlcjkmcwpzk.elementnew(substitution(), true)
						);
							...
							if (isToReplace) {
								...
								replacement.each(function(sub) {
									$_gdbsl0nvjkmcwqh8.mutateCell(
										grid[i],
										j,
										$_7jwbndlcjkmcwpzk.elementnew(sub, true)
									);
								});
							}
						}
		...
		var isSpanning = function(grid, row, col, comparator) {
			...
			return (
				grid.length > 1 &&
				$_gdbsl0nvjkmcwqh8.cellLength(currentRow) > 1 &&
				((col > 0 &&
					matching(
						$_gdbsl0nvjkmcwqh8.getCellElement(currentRow, col - 1)
					)) ||
					(col < currentRow.length - 1 &&
						matching(
							$_gdbsl0nvjkmcwqh8.getCellElement(
								currentRow,
								col + 1
							)
						)) ||
			...
			for (var r = startRow; r < endRow; r++) {
				for (var c = startCol; c < endCol; c++) {
					if (isSpanning(gridA, r, c, comparator)) {
						$_1kx5x1oajkmcwqkb.unmerge(
							gridA,
							$_gdbsl0nvjkmcwqh8.getCellElement(gridA[r], c),
							comparator,
							generator.cell
						);
					}
					var newCell = $_gdbsl0nvjkmcwqh8.getCellElement(
						gridB[r - startRow],
						c - startCol
					);
					...
					$_gdbsl0nvjkmcwqh8.mutateCell(
						gridA[r],
						c,
						$_7jwbndlcjkmcwpzk.elementnew(replacement, true)
					);
				}
			}
			return gridA;
		...
		var merge$3 = function(
			...
			return result.map(function(delta) {
				var fittedGrid = $_9oir64o8jkmcwqk0.tailor(
					gridA,
					delta,
					generator
				);
		...
		var insert = function(index, gridA, gridB, generator, comparator) {
			...
			var fittedNewGrid = $_9oir64o8jkmcwqk0.tailor(
				gridB,
				delta,
				generator
			);
			var secondDelta = $_9oir64o8jkmcwqk0.measureWidth(
				gridA,
				fittedNewGrid
			);
			var fittedOldGrid = $_9oir64o8jkmcwqk0.tailor(
				gridA,
				secondDelta,
				generator
			);
		...
		var insertRowAt = function(
			...
			var between = $_gdbsl0nvjkmcwqh8.mapCells(grid[example], function(
				ex,
				c
			) {
				var withinSpan =
					...
					index < grid.length &&
					comparator(
						$_gdbsl0nvjkmcwqh8.getCellElement(grid[index - 1], c),
						$_gdbsl0nvjkmcwqh8.getCellElement(grid[index], c)
					);
				var ret = withinSpan
					? $_gdbsl0nvjkmcwqh8.getCell(grid[index], c)
					: $_7jwbndlcjkmcwpzk.elementnew(
		...
		var insertColumnAt = function(
			...
			return map(grid, function(row) {
				var withinSpan =
					index > 0 &&
					index < $_gdbsl0nvjkmcwqh8.cellLength(row) &&
					comparator(
						$_gdbsl0nvjkmcwqh8.getCellElement(row, index - 1),
						$_gdbsl0nvjkmcwqh8.getCellElement(row, index)
					);
				var sub = withinSpan
					? $_gdbsl0nvjkmcwqh8.getCell(row, index)
					: $_7jwbndlcjkmcwpzk.elementnew(
							substitution(
								$_gdbsl0nvjkmcwqh8.getCellElement(row, example),
								comparator
							),
							true
					  );
		...
		var splitCellIntoColumns = function(
			...
			return map(grid, function(row, i) {
				...
				var sub = isTargetCell
					...
					: $_gdbsl0nvjkmcwqh8.getCell(row, exampleCol);
				return $_gdbsl0nvjkmcwqh8.addCell(row, index, sub);
			});
		};
		var splitCellIntoRows = function(
			...
			var before = grid.slice(0, index);
			var after = grid.slice(index);
			var between = $_gdbsl0nvjkmcwqh8.mapCells(
				grid[exampleRow],
				function(ex, i) {
		...
		var notStartRow = function(grid, rowIndex, colIndex, comparator) {
			return (
				$_gdbsl0nvjkmcwqh8.getCellElement(grid[rowIndex], colIndex) !==
					undefined &&
				rowIndex > 0 &&
					comparator(
						$_gdbsl0nvjkmcwqh8.getCellElement(
		...
		var neighbours$1 = function(input, index) {
			if (input.length === 0) return $_4st45oofjkmcwql8.none();
			if (input.length === 1) return $_4st45oofjkmcwql8.only(0);
			if (index === 0) return $_4st45oofjkmcwql8.left(0, 1);
		...
		var getSpan$1 = function(cell, type) {
			return (
				$_98tfuqm2jkmcwq3d.has(cell, type) &&
				parseInt($_98tfuqm2jkmcwq3d.get(cell, type), 10) > 1
			);
		};
		...
		var getRaw$1 = function(cell, property, getter) {
			return $_b9b72cmbjkmcwq4u.getRaw(cell, property).fold(
				function() {
		...
		var getWidthFrom = function(
			...
			return map(columns, function(cellOption, c) {
				var columnCell = cellOption.filter(
					not($_67wb16ohjkmcwqlj.hasColspan)
				);
		...
		var getPercentageWidths = function(warehouse, direction, tableSize) {
			return getWidthFrom(
				warehouse,
				direction,
				$_expxtvn7jkmcwqc2.getPercentageWidth,
				function(deduced) {
					return deduced.fold(
						function() {
		...
		var getPixelWidths = function(warehouse, direction, tableSize) {
			return getWidthFrom(
				warehouse,
				direction,
				$_expxtvn7jkmcwqc2.getPixelWidth,
				function(deduced) {
		...
		var getHeightFrom = function(
			...
			return map(rows, function(cellOption, c) {
				var rowCell = cellOption.filter(
					not($_67wb16ohjkmcwqlj.hasRowspan)
				);
				return rowCell.fold(
					function() {
						var deduced = $_cmkixrnzjkmcwqiw.deduce(backups, c);
		...
		var adjustWidth = function(table, delta, index, direction) {
			...
			var deltas = $_9pnpssoejkmcwql2.determine(
				widths,
				index,
				step,
				tableSize
			...
			var newSizes = $_3gmpy8oijkmcwqlr.recalculateWidth(
				warehouse,
				newWidths
			);
		...
		var adjustHeight = function(table, delta, index, direction) {
			var warehouse = getTableWarehouse(table);
			var heights = $_1uws4ogjkmcwqla.getPixelHeights(
				warehouse,
				direction
			);
			var newHeights = map(heights, function(dy, i) {
				return index === i
					? Math.max(delta + dy, $_67wb16ohjkmcwqlj.minHeight())
					: dy;
			});
			var newCellSizes = $_3gmpy8oijkmcwqlr.recalculateHeight(
				warehouse,
				newHeights
			);
			var newRowSizes = $_3gmpy8oijkmcwqlr.matchRowHeight(
				warehouse,
				newHeights
			);
		...
		var prune = function(table) {
			...
			if (cells.length === 0) $_af3mfpmejkmcwq5b.remove(table);
		};
		...
		var insertRowBefore = function(grid, detail, comparator, genWrappers) {
			...
			var newGrid = $_acaqnobjkmcwqki.insertRowAt(
				grid,
				targetIndex,
				example,
				comparator,
		...
		var insertRowsBefore = function(
			...
			var newGrid = foldl(
				...
				function(newGrid, _row) {
					return $_acaqnobjkmcwqki.insertRowAt(
						newGrid,
						targetIndex,
						example,
						comparator,
		...
		var insertColumnBefore = function(
			...
			var newGrid = $_acaqnobjkmcwqki.insertColumnAt(
				grid,
				targetIndex,
				example,
				comparator,
		...
		var insertColumnsBefore = function(
			...
			var newGrid = foldl(
				columns,
				function(newGrid, _row) {
					return $_acaqnobjkmcwqki.insertColumnAt(
						newGrid,
						targetIndex,
						example,
						comparator,
		...
		var makeRowHeader = function(grid, detail, comparator, genWrappers) {
			var newGrid = $_87xjc2ocjkmcwqkn.replaceRow(
				grid,
				detail.row(),
				comparator,
		...
		var makeColumnHeader = function(grid, detail, comparator, genWrappers) {
			var newGrid = $_87xjc2ocjkmcwqkn.replaceColumn(
				grid,
				detail.column(),
				comparator,
				genWrappers.replaceOrInit
		...
		var splitCellIntoColumns$1 = function(
			...
			var newGrid = $_acaqnobjkmcwqki.splitCellIntoColumns(
				grid,
				detail.row(),
				detail.column(),
				comparator,
		...
		var splitCellIntoRows$1 = function(
			...
			var newGrid = $_acaqnobjkmcwqki.splitCellIntoRows(
				grid,
				detail.row(),
				detail.column(),
				comparator,
		...
		var eraseColumns = function(grid, details, comparator, _genWrappers) {
			var columns = uniqueColumns(details);
			var newGrid = $_acaqnobjkmcwqki.deleteColumnsAt(
				grid,
				columns[0].column(),
		...
		var eraseRows = function(grid, details, comparator, _genWrappers) {
			var rows = uniqueRows(details);
			var newGrid = $_acaqnobjkmcwqki.deleteRowsAt(
				grid,
				rows[0].row(),
		...
		var mergeCells = function(grid, mergable, comparator, _genWrappers) {
			...
			var newGrid = $_1kx5x1oajkmcwqkb.merge(
				grid,
				mergable.bounds(),
				comparator,
				constant(cells[0])
		...
		var unmergeCells = function(grid, unmergable, comparator, genWrappers) {
			var newGrid = foldr(
				unmergable,
				function(b, cell) {
					return $_1kx5x1oajkmcwqkb.unmerge(
						b,
						cell,
						comparator,
		...
		var pasteCells = function(grid, pasteDetails, comparator, genWrappers) {
			...
			var startAddress = $_7jwbndlcjkmcwpzk.address(
				pasteDetails.row(),
				pasteDetails.column()
			);
			var mergedGrid = $_a7znhho7jkmcwqjv.merge(
				startAddress,
				grid,
				gridB,
				pasteDetails.generators(),
		...
		var pasteRowsBefore = function(
			...
			var mergedGrid = $_a7znhho7jkmcwqjv.insert(
				index,
				grid,
				gridB,
				pasteDetails.generators(),
		...
		var $_dyoy2enjjkmcwqe1 = {
			insertRowBefore: $_2sk7xunqjkmcwqg9.run(
				insertRowBefore,
				$_2sk7xunqjkmcwqg9.onCell,
				noop,
				noop,
				$_alg1u9nkjkmcwqej.modification
			),
			insertRowsBefore: $_2sk7xunqjkmcwqg9.run(
				insertRowsBefore,
				$_2sk7xunqjkmcwqg9.onCells,
				noop,
				noop,
				$_alg1u9nkjkmcwqej.modification
			),
			insertRowAfter: $_2sk7xunqjkmcwqg9.run(
				insertRowAfter,
				$_2sk7xunqjkmcwqg9.onCell,
				noop,
				noop,
			...
			insertRowsAfter: $_2sk7xunqjkmcwqg9.run(
				insertRowsAfter,
				$_2sk7xunqjkmcwqg9.onCells,
				noop,
				noop,
			...
			insertColumnBefore: $_2sk7xunqjkmcwqg9.run(
				insertColumnBefore,
				$_2sk7xunqjkmcwqg9.onCell,
				resize,
				noop,
			...
			insertColumnsBefore: $_2sk7xunqjkmcwqg9.run(
				insertColumnsBefore,
				$_2sk7xunqjkmcwqg9.onCells,
				resize,
				noop,
			...
			insertColumnAfter: $_2sk7xunqjkmcwqg9.run(
				insertColumnAfter,
				$_2sk7xunqjkmcwqg9.onCell,
				resize,
				noop,
			...
			insertColumnsAfter: $_2sk7xunqjkmcwqg9.run(
				insertColumnsAfter,
				$_2sk7xunqjkmcwqg9.onCells,
				resize,
				noop,
			...
			splitCellIntoColumns: $_2sk7xunqjkmcwqg9.run(
			...
			splitCellIntoRows: $_2sk7xunqjkmcwqg9.run(
				splitCellIntoRows$1,
				$_2sk7xunqjkmcwqg9.onCell,
				noop,
				noop,
			...
			eraseColumns: $_2sk7xunqjkmcwqg9.run(
				eraseColumns,
				$_2sk7xunqjkmcwqg9.onCells,
				resize,
				prune,
			...
			eraseRows: $_2sk7xunqjkmcwqg9.run(
				eraseRows,
				$_2sk7xunqjkmcwqg9.onCells,
				noop,
				prune,
			...
			makeColumnHeader: $_2sk7xunqjkmcwqg9.run(
				makeColumnHeader,
				$_2sk7xunqjkmcwqg9.onCell,
				noop,
				noop,
				$_alg1u9nkjkmcwqej.transform('row', 'th')
			),
			unmakeColumnHeader: $_2sk7xunqjkmcwqg9.run(
				unmakeColumnHeader,
				$_2sk7xunqjkmcwqg9.onCell,
				noop,
				noop,
				$_alg1u9nkjkmcwqej.transform(null, 'td')
			),
			makeRowHeader: $_2sk7xunqjkmcwqg9.run(
				makeRowHeader,
				$_2sk7xunqjkmcwqg9.onCell,
				noop,
				noop,
				$_alg1u9nkjkmcwqej.transform('col', 'th')
			),
			unmakeRowHeader: $_2sk7xunqjkmcwqg9.run(
				unmakeRowHeader,
				$_2sk7xunqjkmcwqg9.onCell,
				noop,
				noop,
			...
			mergeCells: $_2sk7xunqjkmcwqg9.run(
				mergeCells,
				$_2sk7xunqjkmcwqg9.onMergable,
				noop,
				noop,
				$_alg1u9nkjkmcwqej.merging
			),
			unmergeCells: $_2sk7xunqjkmcwqg9.run(
				unmergeCells,
				$_2sk7xunqjkmcwqg9.onUnmergable,
				resize,
				noop,
				$_alg1u9nkjkmcwqej.merging
			),
			pasteCells: $_2sk7xunqjkmcwqg9.run(
				pasteCells,
				$_2sk7xunqjkmcwqg9.onPaste,
				resize,
				noop,
				$_alg1u9nkjkmcwqej.modification
			),
			pasteRowsBefore: $_2sk7xunqjkmcwqg9.run(
				pasteRowsBefore,
				$_2sk7xunqjkmcwqg9.onPasteRows,
				noop,
				noop,
				$_alg1u9nkjkmcwqej.modification
			),
			pasteRowsAfter: $_2sk7xunqjkmcwqg9.run(
				pasteRowsAfter,
				$_2sk7xunqjkmcwqg9.onPasteRows,
				noop,
				noop,
		...
		var removeDataStyle = function(table) {
			var dataStyleCells = $_6ib2l3m4jkmcwq3n.descendants(
				table,
		...
		var getDirection = function(element) {
			return $_b9b72cmbjkmcwq4u.get(element, 'direction') === 'rtl'
				? 'rtl'
				: 'ltr';
		};
		...
		var TableActions = function(editor, lazyWire) {
			...
			var execute = function(operation, guard, mutate, lazyWire) {
				return function(table, target) {
					...
					var direction = TableDirection(
						$_29wc7uoljkmcwqmg.directionAt
					);
					var generators = $_8pf0kgmgjkmcwq5j.cellOperations(
						mutate,
						doc,
						cloneFormats
					);
			...
			var deleteRow = execute(
				$_dyoy2enjjkmcwqe1.eraseRows,
				lastRowGuard,
				noop,
				lazyWire
			);
			var deleteColumn = execute(
				$_dyoy2enjjkmcwqe1.eraseColumns,
				lastColumnGuard,
				noop,
				lazyWire
			);
			var insertRowsBefore = execute(
				$_dyoy2enjjkmcwqe1.insertRowsBefore,
				always,
				noop,
				lazyWire
			);
			var insertRowsAfter = execute(
				$_dyoy2enjjkmcwqe1.insertRowsAfter,
				always,
				noop,
				lazyWire
			);
			var insertColumnsBefore = execute(
				$_dyoy2enjjkmcwqe1.insertColumnsBefore,
				always,
				$_c5cuhwn6jkmcwqc0.halve,
				lazyWire
			);
			var insertColumnsAfter = execute(
				$_dyoy2enjjkmcwqe1.insertColumnsAfter,
				always,
				$_c5cuhwn6jkmcwqc0.halve,
				lazyWire
			);
			var mergeCells = execute(
				$_dyoy2enjjkmcwqe1.mergeCells,
				always,
				noop,
				lazyWire
			);
			var unmergeCells = execute(
				$_dyoy2enjjkmcwqe1.unmergeCells,
				always,
				noop,
				lazyWire
			);
			var pasteRowsBefore = execute(
				$_dyoy2enjjkmcwqe1.pasteRowsBefore,
				always,
				noop,
				lazyWire
			);
			var pasteRowsAfter = execute(
				$_dyoy2enjjkmcwqe1.pasteRowsAfter,
				always,
				noop,
				lazyWire
			);
			var pasteCells = execute(
				$_dyoy2enjjkmcwqe1.pasteCells,
				always,
				noop,
				lazyWire
			);
		...
		var copyRows = function(table, target, generators) {
			...
			return details.map(function(selectedCells) {
				...
				var slicedDetails = $_2sk7xunqjkmcwqg9.toDetailList(
					slicedGrid,
					generators
				);
		...
		var extractDataFromElement = function(editor, elm) {
			...
			if (hasAdvancedCellTab(editor)) {
				global$1.extend(
					data,
					$_79uus4oujkmcwqnx.extractAdvancedStyles(dom, elm)
				);
			}
			return data;
		};
		...
		var open = function(editor) {
			...
			if (getCellClassList(editor).length > 0) {
				classListCtrl = {
					...
					type: 'listbox',
					label: 'Class',
					values: $_79uus4oujkmcwqnx.buildListItems(
						...
						items: [
							{
								...
								name: 'width',
								onchange: curry(
									$_79uus4oujkmcwqnx.updateStyleField,
									editor
								)
							},
							{
		...
		var fireEvents = function(editor, table) {
			each($_6ib2l3m4jkmcwq3n.descendants(table, 'tr'), function(row) {
				fireNewRow(editor, row.dom());
				each($_6ib2l3m4jkmcwq3n.descendants(row, 'th,td'), function(
					cell
				) {
					fireNewCell(editor, cell.dom());
				});
				...
				.map(function(table) {
					if (isPixelsForced(editor)) {
						$_b9b72cmbjkmcwq4u.set(
							table,
							'width',
							$_b9b72cmbjkmcwq4u.get(table, 'width')
						);
					}
		...
		var extractDataFromElement$2 = function(editor, tableElm) {
			...
			var data = {
				...
				cellpadding:
					...
					$_23sq1sotjkmcwqnu.getTDTHOverallStyle(
						editor.dom,
						tableElm,
						'padding'
					),
			...
			if (hasAdvancedTableTab(editor)) {
				global$1.extend(
					data,
					$_79uus4oujkmcwqnx.extractAdvancedStyles(dom, tableElm)
				);
			}
			return data;
		};
		...
		var onSubmitTableForm = function(editor, tableElm, evt) {
			...
			editor.undoManager.transact(function() {
				if (!tableElm) {
					tableElm = $_37y5yboyjkmcwqos.insert(
						editor,
						data.cols || 1,
						data.rows || 1
					);
		...
		var registerCommands = function(
			...
			var actOnSelection = function(execute) {
				...
				table.each(function(table) {
					var targets = $_6606lumnjkmcwq6y.forMenu(
						selections,
						table,
						cell
					);
			...
			var copyRowSelection = function(execute) {
				...
				return table.bind(function(table) {
					...
					return $_gap17qoqjkmcwqnh.copyRows(
						table,
						targets,
						generators
					);
			...
			var pasteOnSelection = function(execute) {
				clipboardRows.get().each(function(rows) {
					...
					table.bind(function(table) {
						var doc = Element$$1.fromDom(editor.getDoc());
						var generators = $_8pf0kgmgjkmcwq5j.paste(doc);
						var targets = $_6606lumnjkmcwq6y.pasteRows(
							selections,
							table,
							cell,
							clonedRows,
		...
		function Blocker(options) {
			var settings = merge$1(
				{ layerClass: $_7vi2f1pcjkmcwqsm.resolve('blocker') },
				options
			);
		...
		var capture$1 = function(element, event, handler) {
			return $_atu4x2pejkmcwqss.capture(
				element,
				event,
				filter$1,
				handler
		...
		var sink$1 = function(dragApi, settings) {
			...
			var mdown = $_fe01uvpdjkmcwqsp.bind(
				blocker.element(),
				'mousedown',
				dragApi.forceDrop
			);
			var mup = $_fe01uvpdjkmcwqsp.bind(
				blocker.element(),
				'mouseup',
				dragApi.drop
			);
			var mmove = $_fe01uvpdjkmcwqsp.bind(
				blocker.element(),
				'mousemove',
				dragApi.move
			);
			var mout = $_fe01uvpdjkmcwqsp.bind(
				blocker.element(),
				'mouseout',
				dragApi.delayDrop
			);
		...
		var resizeBarDragging = $_10r949o1jkmcwqjc.resolve(
		...
		function BarManager(wire, direction, hdirection) {
			...
			mutation.events.drag.bind(function(event) {
				getResizer(event.target(), 'data-row').each(function(_dataRow) {
					var currentRow = $_67wb16ohjkmcwqlj.getInt(
						event.target(),
						'top'
					);
					$_b9b72cmbjkmcwq4u.set(
				...
				getResizer(event.target(), 'data-column').each(function(
					_dataCol
				) {
					var currentCol = $_67wb16ohjkmcwqlj.getInt(
						event.target(),
						'left'
					);
					$_b9b72cmbjkmcwq4u.set(
			...
			var getDelta = function(target, direction) {
				...
				var oldX = parseInt(
					$_98tfuqm2jkmcwq3d.get(target, 'data-initial-' + direction),
					10
				);
				return newX - oldX;
			};
			resizing.events.stop.bind(function() {
				mutation.get().each(function(target) {
					hoverTable.each(function(table) {
						...
						getResizer(target, 'data-column').each(function(
							column
						) {
			...
			var mouseover = $_fe01uvpdjkmcwqsp.bind(
				wire.view(),
				'mouseover',
				function(event) {
					if (
						$_5hranzm3jkmcwq3l.name(event.target()) === 'table' ||
						$_8hvjz2pmjkmcwqtv.closest(
							event.target(),
							'table',
							isRoot
						)
		...
		function TableResize(wire, vdirection) {
			...
			manager.events.adjustHeight.bind(function(event) {
				...
				$_c1phphodjkmcwqkx.adjustHeight(
					event.table(),
					delta,
					event.row(),
					hdirection
		...
		var get$8 = function(editor, container) {
			return editor.inline
				? $_di2oicp3jkmcwqpx.body(getBody$1(editor), createContainer())
				: $_di2oicp3jkmcwqpx.only(Element$$1.fromDom(editor.getDoc()));
		};
			...
			return detection.fold(
				...
				function(info) {
					return info.index() + 1 < info.all().length
						? $_5k9tbfpqjkmcwqv2.middle(
								current,
								info.all()[info.index() + 1]
						  )
						: $_5k9tbfpqjkmcwqv2.last(current);
				}
			);
		};
			...
			return detection.fold(
				...
				function(info) {
					return info.index() - 1 >= 0
						...
						: $_5k9tbfpqjkmcwqv2.first(current);
				}
			);
		};
		...
		var after$2 = function(start, soffset, finish, foffset) {
			var r = makeRange(start, soffset, finish, foffset);
			var same =
				$_3jfu9slljkmcwq20.eq(start, finish) && soffset === foffset;
		...
		var getRanges = function(win, selection) {
			return selection.match({
				...
				relative: function(startSitu, finishSitu) {
					return {
						ltr: cached(function() {
							return $_dsvnrgpwjkmcwqvr.relativeToNative(
								win,
								startSitu,
								finishSitu
							);
						...
						rtl: cached(function() {
							return Option.some(
								$_dsvnrgpwjkmcwqvr.relativeToNative(
									win,
									finishSitu,
									startSitu
								)
				...
				exact: function(start, soffset, finish, foffset) {
					return {
						ltr: cached(function() {
							return $_dsvnrgpwjkmcwqvr.exactToNative(
								win,
								start,
								soffset,
								finish,
						...
						rtl: cached(function() {
							return Option.some(
								$_dsvnrgpwjkmcwqvr.exactToNative(
									win,
									finish,
									foffset,
									start,
		...
		var locateOffset = function(doc, textnode, x, y, rect) {
			...
			var offset = $_95b1oq0jkmcwqwn.searchForPoint(
				rectForOffset,
				x,
				y,
				rect.right,
		...
		var locate = function(doc, node, x, y) {
			...
			var foundRect = findMap(rects, function(rect) {
				return $_95b1oq0jkmcwqwn.inRect(rect, x, y)
					? Option.some(rect)
					: Option.none();
			});
		...
		var searchInChildren = function(doc, node, x, y) {
			...
			return findMap(nodes, function(n) {
				r.selectNode(n.dom());
				return $_95b1oq0jkmcwqwn.inRect(r.getBoundingClientRect(), x, y)
					? locateNode(doc, n, x, y)
					: Option.none();
			});
		};
		var locateNode = function(doc, node, x, y) {
			var locator = $_5hranzm3jkmcwq3l.isText(node)
				? $_av7xhwq1jkmcwqwp.locate
				: searchInChildren;
		...
		var locateInElement = function(doc, node, x) {
			...
			var f =
				collapseDirection === COLLAPSE_TO_LEFT
					? $_9rdh12mijkmcwq6g.first
					: $_9rdh12mijkmcwq6g.last;
		...
		var search = function(doc, node, x) {
			var f =
				$_9z5e1kljjkmcwq1g.children(node).length === 0
					? locateInEmpty
					: locateInElement;
			return f(doc, node, x);
		};
		...
		var searchFromPoint = function(doc, x, y) {
			return Element$$1.fromPoint(doc, x, y).bind(function(elem) {
				...
				return $_9z5e1kljjkmcwq1g.children(elem).length === 0
					? fallback()
		...
		var fromPoint$1 = function(win, x, y) {
			...
			return availableSearch(doc, x, y).map(function(rng) {
				return $_6m1l5tprjkmcwqv4.range(
		...
		var withinContainer = function(win, ancestor, outerRange, selector) {
			...
			var self = $_dvr0jtlfjkmcwq0n.is(ancestor, selector)
				? [ancestor]
				: [];
			var elements = self.concat(
				$_6ib2l3m4jkmcwq3n.descendants(ancestor, selector)
			);
		...
		var find$3 = function(win, selection, selector) {
			...
			return $_5hranzm3jkmcwq3l.isElement(ancestor)
		...
		var beforeSpecial = function(element, offset) {
			...
			if ('input' === name) return $_6serovpsjkmcwqv9.after(element);
			else if (!contains(['br', 'img'], name))
				return $_6serovpsjkmcwqv9.on(element, offset);
			else
				return offset === 0
					? $_6serovpsjkmcwqv9.before(element)
					: $_6serovpsjkmcwqv9.after(element);
		};
		var preprocessRelative = function(startSitu, finishSitu) {
			var start = startSitu.fold(
				$_6serovpsjkmcwqv9.before,
				beforeSpecial,
				$_6serovpsjkmcwqv9.after
			);
		...
		var doSetRange = function(win, start, soffset, finish, foffset) {
			var rng = $_dsvnrgpwjkmcwqvr.exactToNative(
				win,
				start,
				soffset,
				finish,
		...
		var setExact = function(win, start, soffset, finish, foffset) {
			var relative = $_dvfksq4jkmcwqx3.preprocessExact(
				start,
				soffset,
				finish,
				foffset
		...
		var setRelative = function(win, startSitu, finishSitu) {
			var relative = $_dvfksq4jkmcwqx3.preprocessRelative(
				startSitu,
				finishSitu
			);
			setRangeFromRelative(win, relative);
		...
		var doGetExact = function(selection) {
			...
			return $_20ysy4pujkmcwqvl.after(
				anchorNode,
		...
		var get$9 = function(win) {
			return getExact(win).map(function(range) {
				return $_6m1l5tprjkmcwqv4.exact(
					range.start(),
					range.soffset(),
					range.finish(),
					range.foffset()
		...
		var replace$1 = function(win, selection, elements) {
			var rng = $_2u8s7apxjkmcwqw3.asLtrRange(win, selection);
			var fragment = $_eieo73pvjkmcwqvm.fromElements(
				elements,
				win.document
			);
		...
		var handle$1 = function(event, editor, actions, lazyWire) {
			if (event.keyCode === global$3.TAB) {
				...
				var isRoot_1 = function(element) {
					var name = $_5hranzm3jkmcwq3l.name(element);
					return (
						$_3jfu9slljkmcwq20.eq(element, body_1) ||
		...
		function WindowBridge(win) {
			...
			var getRangedRect = function(start, soffset, finish, foffset) {
				var sel = $_6m1l5tprjkmcwqv4.exact(
					start,
					soffset,
					finish,
					foffset
				);
				return $_5g8bk8ptjkmcwqvf
			...
			var fromSitus = function(situs) {
				var relative = $_6m1l5tprjkmcwqv4.relative(
					situs.start(),
					situs.finish()
				);
				...
				return $_ae41j1mqjkmcwq7w
					...
					.bind(function(cellSel) {
						...
						if (boxes.length > 0) {
							...
							return Option.some(
								$_easrp2q8jkmcwqyc.response(
									Option.some(
										$_4yi2x6qbjkmcwqyv.makeSitus(
											start,
											0,
											start,
											$_8b7hivmjjkmcwq6j.getEnd(start)
										)
									),
									true
								)
			...
			if ($_5hranzm3jkmcwq3l.isElement(element))
				...
				return bridge
					.getRangedRect(
						...
						0,
						element,
						$_8b7hivmjjkmcwq6j.getEnd(element)
					)
					.map(toCaret);
			else return Option.none();
		};
		...
		var left$2 = function(universe, item, predicate, isRoot) {
			return hone(
				...
				item,
				predicate,
				$_2dd1wmqmjkmcwr2g.sidestep,
				$_ags1v3qnjkmcwr2o.left(),
				isRoot
			);
		};
		...
		var gather = function(element, prune, transform) {
			return $_7tbhqbqkjkmcwr29.gather(
				universe$2,
				element,
				prune,
				transform
		...
		var seekLeft$1 = function(element, predicate, isRoot) {
			return $_7tbhqbqkjkmcwr29.seekLeft(
				universe$2,
				element,
				predicate,
				isRoot
		...
		var seekRight$1 = function(element, predicate, isRoot) {
			return $_7tbhqbqkjkmcwr29.seekRight(
				universe$2,
				element,
				predicate,
				isRoot
		...
		var inOutsideBlock = function(bridge, element, caret) {
			return $_8rq19vm8jkmcwq44
				.closest(element, $_fm83ehnojkmcwqfz.isBlock)
				.fold(constant(false), function(cell) {
					return $_etarmqqhjkmcwr12
					...
					return $_87tdfem7jkmcwq42
						...
						.map(function(beforeCell) {
							if (!$_3jfu9slljkmcwq20.eq(afterCell, beforeCell)) {
								...
								return $_3jfu9slljkmcwq20.eq(
									after,
									afterCell
								) &&
									$_8b7hivmjjkmcwq6j.getEnd(afterCell) ===
										afterOffset
									? failure(beforeCell)
		...
		var descendantsInAncestor = function(
			...
			return $_87tdfem7jkmcwq42
				...
				.bind(function(ancestor) {
					var descendants = $_6ib2l3m4jkmcwq3n.descendants(
						ancestor,
						descendantSelector
					);
		...
		var gatherer = function(cand, gather, isRoot) {
			return gather(cand, isRoot).bind(function(target) {
				return $_5hranzm3jkmcwq3l.isText(target) &&
					$_gelocgmkjkmcwq6n.get(target).trim().length === 0
		...
		var handleParent = function(isRoot, element, offset, direction) {
			return findBr(element, offset).bind(function(br) {
				return direction.traverse(br).fold(
					...
					function(adjacent) {
						return $_3tnqeaqrjkmcwr3y
							.indexInParent(adjacent)
							.map(function(info) {
								return $_6serovpsjkmcwqv9.on(
									info.parent(),
									info.index()
								);
							});
		...
		var process = function(analysis) {
			return $_73t807qojkmcwr2u.cata(
				...
				function(cell) {
					return Option.some(
						$_3iabnfqqjkmcwr3u.point(
							cell,
							$_8b7hivmjjkmcwq6j.getEnd(cell)
						)
					);
				}
			);
				...
				return $_5xd9dfqpjkmcwr36
					...
					.fold(
						...
						function(brNeighbour) {
							...
							var analysis = $_73t807qojkmcwr2u.verify(
								bridge,
								sel.finish(),
								sel.foffset(),
								range.finish(),
			...
			return tryCursor(bridge, isRoot, element, offset, direction).bind(
				function(situs) {
					...
					return $_73t807qojkmcwr2u.cata(
						...
						function(cell) {
							if (
								$_3jfu9slljkmcwq20.eq(element, cell) &&
								offset === 0
							)
								return tryAgain(
									bridge,
						...
						function(cell) {
							if (
								$_3jfu9slljkmcwq20.eq(element, cell) &&
								offset === $_8b7hivmjjkmcwq6j.getEnd(cell)
							)
								return tryAgain(
									bridge,
									element,
									offset,
									$_6f928oqgjkmcwr0y.moveDown,
									direction
								);
							else
								return scan(
			...
			return $_etarmqqhjkmcwr12
				...
				.bind(function(box) {
					return tryAt(
						bridge,
						direction,
						move(box, $_4tas7tqijkmcwr1a.getJumpSize())
					);
				});
		};
			...
			if (detection.browser.isIE()) {
				...
				return precheck(initial, isRoot).orThunk(function() {
					return simulate(
						...
						return $_easrp2q8jkmcwqyc.response(
							Option.some(
								$_4yi2x6qbjkmcwqyv.makeSitus(
									range.start(),
									range.soffset(),
			...
			return $_87tdfem7jkmcwq42
				...
				.bind(function(startRow) {
					return $_87tdfem7jkmcwq42
						...
						.bind(function(table) {
							var rows = $_6ib2l3m4jkmcwq3n.descendants(
								table,
								'tr'
							);
							if ($_3jfu9slljkmcwq20.eq(startRow, rows[0])) {
								return $_58ad9oqjjkmcwr25
									.seekLeft(
										table,
										function(element) {
											return $_9rdh12mijkmcwq6g
									...
									.map(function(last) {
										var lastOffset = $_8b7hivmjjkmcwq6j.getEnd(
											last
										);
										return $_easrp2q8jkmcwqyc.response(
											Option.some(
		...
		var select = function(
			...
			return simulate(bridge, isRoot, direction, initial, anchor).bind(
				function(info) {
					return $_4lb7niqdjkmcwqzg.detect(
						container,
						isRoot,
						info.start(),
						info.finish(),
						...
						$_ae41j1mqjkmcwq7w
							...
							.each(function(cellSel) {
								...
								if (
									boxes.length > 1 ||
									(boxes.length === 1 &&
										!$_3jfu9slljkmcwq20.eq(start, finish))
								) {
									annotations.selectRange(
										container,
										boxes,
		...
		var keyboard = function(win, container, isRoot, annotations) {
			...
			var keydown = function(
				...
				var handler = $_ae41j1mqjkmcwq7w
					.retrieve(container, annotations.selectedSelector())
					.fold(
						function() {
							if (
								$_c1iwroq9jkmcwqye.isDown(keycode) &&
								shiftKey
							) {
								return curry(
									$_3pct3oqejkmcwqzv.select,
									bridge,
									container,
									isRoot,
									$_5ppuaaqujkmcwr4h.down,
									finish,
									start,
									annotations.selectRange
								);
							} else if (
								$_c1iwroq9jkmcwqye.isUp(keycode) &&
								shiftKey
							) {
								return curry(
									$_3pct3oqejkmcwqzv.select,
								...
								return curry(
									$_3pct3oqejkmcwqzv.navigate,
									bridge,
									isRoot,
									$_5ppuaaqujkmcwr4h.down,
									finish,
									start,
									$_3pct3oqejkmcwqzv.lastDownCheck
								);
								...
								return curry(
									...
									finish,
									start,
									$_3pct3oqejkmcwqzv.firstUpCheck
								);
							} else {
								return Option.none;
							}
						...
						function(selected) {
							var update = function(attempts) {
								return function() {
									var navigation = findMap(attempts, function(
										delta
									) {
										return $_4lb7niqdjkmcwqzg.update(
											delta.rows(),
											delta.cols(),
											container,
											selected,
							...
							if ($_c1iwroq9jkmcwqye.isDown(keycode) && shiftKey)
								...
								$_c1iwroq9jkmcwqye.isNavigation(keycode) &&
								shiftKey === false
							)
		...
		var byClass = function(ephemera) {
			var addSelectionClass = $_8znmk4qwjkmcwr50.addClass(
				ephemera.selected()
			);
			...
			var clear = function(container) {
				var sels = $_6ib2l3m4jkmcwq3n.descendants(
					container,
		...
		function CellSelection$1(editor, lazyResize) {
			...
			editor.on('init', function(e) {
				...
				var syncSelection = function() {
					...
					var shared = $_cqkw3imrjkmcwq8k.sharedOne(
						$_66sys5ldjkmcwpzo.table,
						[start, end]
					);
				...
				var mouseHandlers = $_96xeccq7jkmcwqxz.mouse(
					win,
					body,
					isRoot,
					annotations
				);
				var keyHandlers = $_96xeccq7jkmcwqxz.keyboard(
					win,
					body,
					isRoot,
					annotations
				...
				var keyup = function(event) {
					...
					if (
						...
						$_c1iwroq9jkmcwqye.isNavigation(
				...
				var keydown = function(event) {
					...
					var start = Element$$1.fromDom(rng.startContainer);
					var end = Element$$1.fromDom(rng.endContainer);
					var direction = $_29wc7uoljkmcwqmg
						.directionAt(startContainer)
						.isRtl()
						? $_c1iwroq9jkmcwqye.rtl
						: $_c1iwroq9jkmcwqye.ltr;
					keyHandlers
						.keydown(
							wrappedEvent,
							start,
		...
		var Selections = function(editor) {
			var get = function() {
				var body = getBody$1(editor);
				return $_btnclampjkmcwq7i
					.retrieve(body, $_44m387n2jkmcwqb8.selectedSelector())
					.fold(
						function() {
							if (editor.selection.getStart() === undefined) {
								return $_62kqdcn3jkmcwqba.none();
							} else {
								return $_62kqdcn3jkmcwqba.single(
									editor.selection
								);
							}
						},
				...
				editor.on('nodechange', function(e) {
					...
					targets = cellOpt.bind(function(cellDom) {
						...
						return table.map(function(table) {
							return $_6606lumnjkmcwq6y.forMenu(
								selections,
								table,
								cell
							);
		...
		function Plugin(editor) {
			...
			$_dxen93opjkmcwqmz.registerCommands(
				editor,
				actions,
				cellSelection,
				selections,
			...
			$_7y3gnul0jkmcwpxc.registerEvents(
				editor,
				selections,
				actions,
				cellSelection
			...
			editor.on('PreInit', function() {
				editor.serializer.addTempAttr(
					$_44m387n2jkmcwqb8.firstSelected()
				);
				editor.serializer.addTempAttr(
					$_44m387n2jkmcwqb8.lastSelected()
				);
			});
			if (hasTabNavigation(editor)) {
				editor.on('keydown', function(e) {
					$_acndzupojkmcwqub.handle(
						e,
						editor,
						actions,
