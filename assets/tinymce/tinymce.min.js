...
!(function() {
		...
		(ye = Tt.select = function(e, t, n, r) {
			...
			if (((n = n || []), 1 === l.length)) {
				if (
					...
					if (
						!(t = (ge.find.ID(a.matches[0].replace(Et, St), t) ||
							[])[0])
					)
						return n;
					c && (t = t.parentNode),
	...
	var Ei = function(t, n) {
		...
		Ii = function(e, t, n) {
			...
			return (
				0 < r.length ? hr.set(e, t, r.join(' ')) : hr.remove(e, t), !1
			);
		},
		Mi = function(e) {
			return Pi(e, 'class');
	...
	function wu(t, n, e) {
		...
		return {
			...
			toRange: function() {
				var e;
				return (
					(e = gu(t.ownerDocument)).setStart(t, n), e.setEnd(t, n), e
				);
			},
			getClientRects: r,
			isVisible: function() {
		...
		bc = function(t, n) {
			return function() {
				return A.from(t.dom.getParent(t.selection.getNode(), 'td,th'))
					.bind(function(e) {
						return A.from(t.dom.getParent(e, 'table')).map(function(
							e
						) {
							return gc(t, n, e);
						});
		...
		yc = function(n, r) {
			return function() {
				return A.from(n.dom.getParent(n.selection.getNode(), 'td,th'))
					.bind(function(t) {
						return A.from(n.dom.getParent(t, 'table')).map(function(
							e
						) {
							return vc(n, r, e, t);
						});
	...
	var nf = function(a) {
		...
		Sf = function(i, a, u) {
			return ru([rl.firstPositionIn(u), rl.lastPositionIn(u)], function(
				e,
				t
			) {
		...
		Wf = function(n, r, o) {
			if (Bf(o))
				return (
					Ri.remove(o), Bf(r) && Jl(r), rl.firstPositionIn(r.dom())
				);
			Hf(!0, r), Hf(!1, o);
			var i = qf(r);
			return $f(r, o).fold(
		...
		md = function(t, n, e) {
			var r,
				...
				s =
					((a = e),
					(o = i),
					ru([$r.prevSibling(a), $r.nextSibling(a), o], function(
						e,
						t,
						n
					) {
				...
				return Bf(e)
					...
					: ((t = a),
					  ...
					  rl.navigate(r, t.getBody(), i).bind(function(e) {
							return Lm(n, er.fromDom(e.getNode())).map(function(
								e
							) {
								return !1 === Fr.eq(e, o);
							});
	...
	var Qh = Jh,
		...
		vv = function(e) {
			...
			return (
				dv(t, hv(e)), F(Ki(t, '*[data-mce-bogus]'), Ri.unwrap), fv(t)
			);
		},
		bv = function(n) {
			var e, t, r;
								...
								(function(t) {
									...
									switch (t.mode) {
										...
										case 'specific_textareas':
											ow(nw.select('textarea'), function(
												e
											) {
												(t.editor_deselector &&
													l(
			...
			send: function(e) {
				...
				if (
					...
					if (
						...
						(t = Iw.fire('beforeSend', { xhr: t, settings: e })
							.xhr).send(e.data),
						!e.async)
					)
						return r();
